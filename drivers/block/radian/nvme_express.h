 ...
 *
 * $RCSfile: nvme_express.h,v $
 * $Revision: 1.24 $
 * $Date: 2014/01/06 08:01:00 $
 * $Author: bermanor $
 * $Release: $ Name:  $
 *
...
#define NVME_VNDR_CMD_SYS_DEBUG		0xC5
#define NVME_VNDR_CMD_NOP		0xCC
#define NVME_VNDR_CMD_CREATE_NS		0xD0
#define NVME_VNDR_CMD_DELETE_NS		0xD4

/* HIF low level commands */
// Remove RMS vendor command codes from the nvme_express header
// should not be needed in the driver, but if they are, they
// should be pulled from the firmware header rms_opcodes.h

// #define NVME_VNDR_CMD_QUERY_RANGES	0xDA
// #define NVME_VNDR_CMD_COPY_MOVE		0xDB
// #define NVME_VNDR_CMD_ERASE			0xDC
// #define NVME_VNDR_CMD_SET_CONDITION 0xDD
// #define NVME_VNDR_CMD_MIGRATE_DIE   0xDE
// #define NVME_VNDR_CMD_XFER			0xDF
